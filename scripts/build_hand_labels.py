...
DISCLAIMER: This dataset is automatically generated by scripts/build_hand_labels.py.
It is NOT human-labeled ground truth. Labels are produced by heuristic JD-tier rules
that overlap with ranker feature families — use only for internal diagnostics.
"""
...
def main() -> int:
    ...
    if submission.exists():
        ...
        for cid in sub_ids:
            ...
            labels[cid] = {
                ...
                "rationale": why,
                "labeler": LABELER_HEURISTIC,
                "source": "submission_top100_diagnostic_only",
            }
    ...
    payload = {
        "_provenance": {
            ...
            "generator": "scripts/build_hand_labels.py",
            "n_labels": len(labels),
        },
        "labels": labels,
    }
